        ...
        rl_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (email.getText().toString().equals("") ||
                    ...
                    Toast.makeText(screen3.this, "Làm ơn điền đầy đủ thông tin",
                            Toast.LENGTH_LONG).show();
                }
                else if (!password.getText().toString().equals(confirm_password.getText().toString())) {
                    Toast.makeText(screen3.this, "Mật khẩu không trùng khớp",
                            Toast.LENGTH_LONG).show();
                }
                else {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task< AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(screen3.this, "Tạo tài khoản bị lỗi, hãy thử lại sau!", Toast.LENGTH_LONG).show();
                                    }
                                }
                            })
